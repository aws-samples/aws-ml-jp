########################################################################################################
# The RWKV Language Model - https://github.com/Blealtan/RWKV-LM-LoRA
########################################################################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_url", default="", type=str)  # Model URL to download weight
    ...
    # Download Base Model Weight if not exist
    if args.model_url and not os.path.exists(args.load_model):
        import urllib.request
        print(f"Downloading model from {args.model_url} this may take a while")
        urllib.request.urlretrieve(args.model_url, args.load_model)
